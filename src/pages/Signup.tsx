// filepath: c:\Users\so143\Desktop\kiranagram\frontend\src\pages\Signup.tsx
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to KIRANAGRAM. Redirecting to home...",
        duration: 1000,
      });
  ...
  try {
    ...
    if (data.newUser) {
      ...
      toast({
        ...
        description: "Welcome back to Kiranagram",
      });
      navigate("/home");
    }
